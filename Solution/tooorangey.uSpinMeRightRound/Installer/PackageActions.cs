...
namespace tooorangey.uSpinMeRightRound.Installer
{
    /// <summary>
    /// Tim Geyssens XDT package actoin transformer http://www.nibble.be/?p=461
    /// </summary>
    public class PackageActions
    {
        public class TransformConfig : IPackageAction
        {
            public string Alias()
            {
                return "uSpinMeRightRound.TransformConfig";
            }
            ...
            {
                string str = "<Action runat=\"install\" undo=\"true\" alias=\"uSpinMeRightRound.TransformConfig\" file=\"~/web.config\" xdtfile=\"~/app_plugins/demo/web.config\">" +
                         "</Action>";
